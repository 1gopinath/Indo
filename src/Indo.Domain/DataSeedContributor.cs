        ...
        : IDataSeedContributor, ITransientDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            try
            {
                ...
                /*Employee*/
                var empBill = await _employeeManager.CreateAsync("Bill Gates", "EMP#0001");
                empBill.EmployeeGroup = EmployeeGroup.Buyer;
                empBill.DepartmentId = deptScm.Id;
                empBill.Street = "Home Sweet Home 55";
                empBill.City = "Redmond";
                empBill.State = "Washington";
                empBill.ZipCode = "98052";
                empBill.Phone = "334889800";
                empBill.Email = "bill@employee.com";
                await _employeeRepository.InsertAsync(empBill, autoSave: true);

                var empElon = await _employeeManager.CreateAsync("Elon Musk", "EMP#0002");
                empElon.EmployeeGroup = EmployeeGroup.Sales;
                empElon.DepartmentId = deptSales.Id;
                empElon.Street = "Home Sweet Home 99";
                empElon.City = "Austin";
                empElon.State = "Texas";
                empElon.ZipCode = "78741";
                empElon.Phone = "33367677890";
                empElon.Email = "elon@employee.com";
                await _employeeRepository.InsertAsync(empElon, autoSave: true);
                ...
                /*TypeofCompany*/
                var tcManufactring = await _typeofCompanyManager.CreateAsync("Manufacturing");
                await _typeofCompanyRepository.InsertAsync(tcManufactring, autoSave: true);

                var tcPharma = await _typeofCompanyManager.CreateAsync("Pharma");
                await _typeofCompanyRepository.InsertAsync(tcPharma, autoSave: true);

                var tcAssemble = await _typeofCompanyManager.CreateAsync("Assemble");
                await _typeofCompanyRepository.InsertAsync(tcAssemble, autoSave: true);
