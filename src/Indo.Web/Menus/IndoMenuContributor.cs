...
namespace Indo.Web.Menus
{
    public class IndoMenuContributor : IMenuContributor
    {
        ...
        private async Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            if (await context.IsGrantedAsync(IndoPermissions.Service.Default))
            {
                ...
                if (await context.IsGrantedAsync(IndoPermissions.Service.ServiceMaster))
                {
                ...
                if (await context.IsGrantedAsync(IndoPermissions.Service.ServiceOrderTransaction))
                {
                ...
                if (await context.IsGrantedAsync(IndoPermissions.Service.ServiceOrderReport))
                {
                ...
                if (await context.IsGrantedAsync(IndoPermissions.Service.ServiceOrderByCustomerReport))
                {
                ...
                if (await context.IsGrantedAsync(IndoPermissions.Service.ServiceOrderBySalesExecutiveReport))
                {
            ...
            if (await context.IsGrantedAsync(IndoPermissions.Settings.Default))
            {
                ...
                if (await context.IsGrantedAsync(IndoPermissions.Settings.TypeofCompanyMaster))
                {
                    settingsMenu.AddItem(new ApplicationMenuItem(name: IndoMenus.TypeofCompany, displayName: l["Menu:SettingsTypeofCompany"], url: "~/TypeofCompany", order: 906));
                }

                if (await context.IsGrantedAsync(IndoPermissions.Settings.ItemMaster))
                {
                    settingsMenu.AddItem(new ApplicationMenuItem(name: IndoMenus.Item, displayName: l["Menu:SettingsItem"], url: "~/Item", order: 907));
