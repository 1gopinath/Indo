...
namespace Indo.Web
{
    public class IndoWebAutoMapperProfile : Profile
    {
        public IndoWebAutoMapperProfile()
        {
            ...
            CreateMap<Pages.Company.CreateModel.CompanyCreateViewModel, CompanyCreateDto>();
            ...
            CreateMap<EmployeeReadDto, Pages.Expense.PrintDetailModel.EmployeeViewModel>();
            ...
            /*TypeofCompany*/
            CreateMap<Pages.TypeofCompany.CreateModel.CreateTypeofCompanyViewModel, TypeofCompanyCreateDto>();
            CreateMap<Pages.TypeofCompany.UpdateModel.TypeofCompanyUpdateViewModel, TypeofCompanyUpdateDto>();
            CreateMap<TypeofCompanyReadDto, Pages.TypeofCompany.UpdateModel.TypeofCompanyUpdateViewModel>();

            /*Items*/
            CreateMap<Pages.Items.CreateModel.CreateItemViewModel, ItemCreateDto>();
            CreateMap<Pages.Items.UpdateModel.ItemUpdateViewModel, ItemUpdateDto>();
            CreateMap<ItemReadDto, Pages.Items.UpdateModel.ItemUpdateViewModel>();
