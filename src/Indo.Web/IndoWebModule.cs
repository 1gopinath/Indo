...
namespace Indo.Web
{
    ...
    public class IndoWebModule : AbpModule
    {
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            Configure<RazorPagesOptions>(options =>
            {
                options.Conventions.AuthorizePage("/Service/Index", IndoPermissions.Service.ServiceMaster);
                options.Conventions.AuthorizePage("/ServiceOrder/Index", IndoPermissions.Service.ServiceOrderTransaction);
                options.Conventions.AuthorizePage("/ServiceOrderReport/Index", IndoPermissions.Service.ServiceOrderReport);
                options.Conventions.AuthorizePage("/ServiceOrderByCustomerReport/Index", IndoPermissions.Service.ServiceOrderByCustomerReport);
                options.Conventions.AuthorizePage("/ServiceOrderBySalesExecutiveReport/Index", IndoPermissions.Service.ServiceOrderBySalesExecutiveReport);
            });
            Configure<RazorPagesOptions>(options =>
            {
            ...
            Configure<RazorPagesOptions>(options =>
            {
                ...
                options.Conventions.AuthorizePage("/TypeofConpany/Index", IndoPermissions.Settings.TypeofCompanyMaster);
                options.Conventions.AuthorizePage("/Items/Index", IndoPermissions.Settings.ItemMaster);
