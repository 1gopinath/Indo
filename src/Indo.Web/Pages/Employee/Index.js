$(function () {
    ...
    var grid = new ej.grids.Grid({
        ...
        allowSorting: true,
        sortSettings: { columns: [{ field: 'employeeNumber', direction: 'Descending' }] },
        allowFiltering: true,
        ...
        columns: [
            ...
            {
                field: 'employeeNumber', headerText: 'Employee Number', textAlign: 'Left', width: 100
            },
            {
            ...
            {
                field: 'Designation', headerText: 'Designation', textAlign: 'Left', width: 100
            },
            {
                field: 'departmentName', headerText: 'Department', textAlign: 'Left', width: 100
            },
        ],
        beforeDataBound: () => {
            grid.showSpinner();
    ...
    function reloadGrid() {
        indo.employees.employee.getList()
            .then(function (data) {
    ...
    var helpModal = new abp.ModalManager(abp.appPath + 'Employee/Help');
    var createModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'Employee/Create',
        modalClass: 'EmployeeModal'
    });
    var updateModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'Employee/Update',
        modalClass: 'EmployeeModal'
    });
