$(function () {
                ...
                if (grid.getSelectedRecords().length) {
                    ...
                    abp.message.confirm('Delete this data: ' + selectedRow.name)
                        .then(function (confirmed) {
                            if (confirmed) {
                                indo.typeofCompanies.typeofCompany
    ...
    function reloadGrid() {
        indo.typeofCompanies.typeofCompany.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'TypeofCompany/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'TypeofCompany/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'TypeofCompany/Update');
