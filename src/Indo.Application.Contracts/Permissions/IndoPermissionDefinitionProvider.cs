...
namespace Indo.Permissions
{
    public class IndoPermissionDefinitionProvider : PermissionDefinitionProvider
    {
        public override void Define(IPermissionDefinitionContext context)
        {
            ...
            var servicePermission = crmGroup.AddPermission(IndoPermissions.Service.Default, L("Permission:Service"));
            servicePermission.AddChild(IndoPermissions.Service.ServiceMaster, L("Permission:Service.ServiceMaster"));
            servicePermission.AddChild(IndoPermissions.Service.ServiceOrderTransaction, L("Permission:Service.ServiceOrderTransaction"));
            servicePermission.AddChild(IndoPermissions.Service.ServiceOrderReport, L("Permission:Service.ServiceOrderReport"));
            servicePermission.AddChild(IndoPermissions.Service.ServiceOrderByCustomerReport, L("Permission:Service.ServiceOrderByCustomerReport"));
            servicePermission.AddChild(IndoPermissions.Service.ServiceOrderBySalesExecutiveReport, L("Permission:Service.ServiceOrderBySalesExecutiveReport"));
            ...
            settingsPermission.AddChild(IndoPermissions.Settings.TypeofCompanyMaster, L("Permission:Settings.TypeofCompanyMaster"));
            ...
            settingsPermission.AddChild(IndoPermissions.Settings.ItemMaster, L("Permission:Settings.ItemMaster"));
